...
function Login() {
  ...
  useEffect(() => {
    // Redirigir a Home si existe un usuario en localStorage
  ...
  return (
    <>
      <section className="row g-0 vh-100">
        {" "}
        {/* g-0: quitar margenes negativos (oculta barra de desplazamiento) */}
          ...
          >
            <div className="col-10">
              ...
              <div className="d-flex flex-column form-group my-4">
                <label htmlFor="txtUser" className="fw-bold pb-2">
                  Nombre de Usuario
                </label>
                <input
                  type="text"
              ...
              <div className="d-flex flex-column form-group my-4">
                <label htmlFor="txtPassword" className="fw-bold pb-2">
                  Contraseña
                </label>
                <input
                  type="password"
              ...
              <div className="text-danger">
                {error && (
                  <p>
                    Todos los campos son obligatorios. Por favor, completa toda
                    la información.
                  </p>
                )}
                {loginFailed && (
                  <p>
                    Usuario o contraseña incorrectos. Por favor, verifica tus
              ...
              <input
                ...
                onClick={loginUser}
                className="btn btn-dark boton w-100 mb-4"
              />
            </div>
          </form>
        </div>
